...
--
-- ── How to apply ──
-- Open Supabase Studio → SQL Editor → paste this whole file → Run.
-- It is idempotent (`ALTER TABLE ... IF NOT EXISTS` semantics via DO
...
-- ── Quick sanity check ──
-- After running, every table in the list above should show rowsecurity=true.
-- The Supabase critical warning should clear within minutes.
